...
<!--           <td>
			...
			<td><?php if($row->purchase_status=="1" && $row->cheker_flag=="0"){ ?><a href="{{url('tl_checker_update?id='.$row->id)}}"> <button class="btn btn-success" type="button" value="Checker">Checker</button> </a> <?php } ?></td>
        </tr>
        @endforeach
                ...
                <div id="show_data">
                    <div class="form-group row">
                        ...
                        <div class="input-group date col-md-4">
                            <input type="text" class=" form-control assign_qty" name="return_qty" value="" required >
                        </div>
                    </div>
                    <div class="form-group row">
