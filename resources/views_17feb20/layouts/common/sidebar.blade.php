...
<!--        <div class="pull-left info">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php if(Request::is('users') || Request::is('product_list') || Request::is('list-department') || Request::is('item_list') || Request::is('vendor_list') || Request::is('enq_location_list')){ ?> menu-open <?php } ?>">
          ...
          @endcan
          <ul class="treeview-menu" <?php if(Request::is('users') || Request::is('product_list') || Request::is('list-department') || Request::is('item_list') || Request::is('vendor_list') || Request::is('enq_location_list')){ ?> style="display:block" <?php } ?>>
