...
<!--                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control alpha"  placeholder="Location Name" value="" id="loc_name" name="loc_name"  required >
                            </div>
                    ...
                    <div class="box-footer">
                        ...
                        <a href="{{url('enq_location_add')}}" class="btn btn-danger" >Cancel</a>
                    </div>
                </form>
            </div>
        </div>   
