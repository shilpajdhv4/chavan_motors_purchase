...
<div class="login-box">
  <div class="login-logo">
    <a href="http://chavanautowheels.com/chavan_motors_purchase/public/dm-login" style="color:white;"><b>Chavan </b>Motors</a>
  </div>
  <div class="login-box-body">
    <p class="login-box-msg">DM Log in to start your session</p>
                        @isset($url)
