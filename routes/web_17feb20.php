...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::get('departmentValidate/{id}','DepartmentController@departmentValidate');
    Route::get('gstValidate/{id}','DepartmentController@gstValidate');
    Route::get('mobValidate/{id}','DepartmentController@mobValidate');
    Route::get('panValidate/{id}','DepartmentController@panValidate');
    Route::get('sub_cat_validate/{id}','DepartmentController@subcatValidate');
